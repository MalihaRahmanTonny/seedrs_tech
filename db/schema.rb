...
ActiveRecord::Schema[7.0].define(version: 2022_06_24_163640) do
  ...
  create_table "campaigns", force: :cascade do |t|
    ...
    t.float "target_amount", null: false
    t.string "sector", null: false
    t.string "country", null: false
    t.float "investment_multiple", default: 0.0, null: false
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["country"], name: "index_campaigns_on_country"
    t.index ["investment_multiple"], name: "index_campaigns_on_investment_multiple"
